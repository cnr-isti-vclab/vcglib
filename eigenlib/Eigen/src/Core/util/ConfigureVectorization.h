...
// removed as gcc 4.1 and msvc 2008 are not supported anyways.
  ...
  #include <malloc.h> // for _aligned_malloc -- need it regardless of whether vectorization is enabled
    ...
    // Disable AVX support on broken xcode versions
      ...
      // when XCode 11.0 and Mac deployment target macOS 10.15 is xxxps://trac.macports.org/ticket/58776#no1
...
// See also: xxxps://bugs.llvm.org/show_bug.cgi?id=47955
  ...
  #define EIGEN_HAS_FP16_C
    ...
    // xxxps://software.intel.com/sites/landingpage/IntrinsicsGuide/#othertechs=FP16C&expand=1711
    #include <immintrin.h>
  #endif
#endif
