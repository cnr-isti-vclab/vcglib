...
namespace Eigen
{
  ...
  /** \class EulerAngles
    ...
    *
    * More information about Euler angles: xxxps://en.wikipedia.org/wiki/Euler_angles
    *
    ...
    public:
      ...
      */
      ...
      /*EulerAngles& fromQuaternion(const QuaternionType& q)
      {
        ...
        // According to xxxp://www.euclideanspace.com/maths/geometry/rotations/conversions/quaternionToEuler/
