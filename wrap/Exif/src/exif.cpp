...
#define PROCESS_TABLE_SIZE  (int)(sizeof(ProcessTable) / sizeof(TagTable_t))
...
#define TAG_TABLE_SIZE  (int)(sizeof(TagTable) / sizeof(TagTable_t))
    ...
    for (de=0;de<NumDirEntries;de++){
        ...
        switch(Tag){
            ...
            case TAG_EXIF_IMAGEWIDTH:
                ...
                if (ImageInfo.ExifImageWidth < a) ImageInfo.ExifImageWidth = a;
                break;

            case TAG_FOCAL_PLANE_XRES:
                ImageInfo.FocalplaneXRes = ConvertAnyFormat(ValuePtr, Format);
                break;
