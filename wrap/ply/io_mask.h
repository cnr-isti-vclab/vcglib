...
****************************************************************************/
#ifndef __VCGLIB_PLY_IO_MASK
#define __VCGLIB_PLY_IO_MASK
...
enum {
  ...
  PM_VERTCOORD    = 0x0001,
	...
	PM_TETRAINDEX    = 0x010000,
	PM_TETRAFLAGS    = 0x020000,
	PM_TETRACOLOR    = 0x040000,
	PM_TETRAQUALITY  = 0x080000,
	PM_TETRANORMAL   = 0x100000,

	PM_FLAGS        = PM_VERTFLAGS + PM_FACEFLAGS + PM_TETRAFLAGS,
